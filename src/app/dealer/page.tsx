...
export default function DealerPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-950 text-zinc-100 font-sans p-6">
      <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-[32px] p-8 text-center space-y-8 shadow-lg">
        <div className="mx-auto w-16 h-16 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 border border-indigo-100 mb-4">
          <Shield className="w-8 h-8" />
        </div>

        <div>
          <h1 className="text-3xl font-black text-zinc-100 tracking-tight mb-2">호스트 시작하기</h1>
        ...
        {!isConnected ? (
          ...
          <button
            ...
            disabled={isCreating}
            className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-xl text-base font-bold transition-colors disabled:shadow-none"
          >
